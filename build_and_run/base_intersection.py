    ...
    #all interfearing paths
        ...
        self.vg = VehicleGenerator({
            ...
            'vehicles': [
                ...
                (1, {'path': [0, 16, 12], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (0, 225, 0)}),
                (1, {'path': [1, 17, 13], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (0, 225, 0)}),
                (1, {'path': [1, 24, 11], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (0, 225, 0)}),
                (1, {'path': [0, 28, 14], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (0, 225, 0)}),

                #East [Inner Straight, Outer Straight, Right Turn, Left Turn]
                (1, {'path': [2, 18, 14], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 0, 0)}),
                (1, {'path': [3, 19, 15], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 0, 0)}),
                (1, {'path': [3, 25, 13], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 0, 0)}),
                (1, {'path': [2, 29, 8], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 0, 0)}),
                ...
                (1, {'path': [5, 26, 15], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 0, 225)}),
                (1, {'path': [4, 30, 10], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 0, 225)}),
                ...
                (1, {'path': [7, 23, 11], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 225, 0)}),
                (1, {'path': [7, 27, 9], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 225, 0)}),
        ...
        self.sdvg = VehicleGenerator({
            ...
            'vehicles': [
                #South [Inner Straight, Outer Straight, Right Turn, Left Turn]
                (1, {'path': [0, 16, 12], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (0, 225, 100)}),
                (1, {'path': [1, 17, 13], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (0, 225, 100)}),
                (1, {'path': [1, 24, 11], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (0, 225, 100)}),
                (1, {'path': [0, 28, 14], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (0, 225, 100)}),

                #East [Inner Straight, Outer Straight, Right Turn, Left Turn]
                (1, {'path': [2, 18, 14], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 0, 100)}),
                (1, {'path': [3, 19, 15], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 0, 100)}),
                (1, {'path': [3, 25, 13], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 0, 100)}),
                (1, {'path': [2, 29, 8], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 0, 100)}),

                #North [Inner Straight, Outer Straight, Right Turn, Left Turn]
                (1, {'path': [4, 20, 8], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 100, 225)}),
                (1, {'path': [5, 21, 9], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 100, 225)}),
                (1, {'path': [5, 26, 15], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 100, 225)}),
                (1, {'path': [4, 30, 10], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 100, 225)}),
           
                #West [Inner Straight, Outer Straight, Right Turn, Left Turn]
                (1, {'path': [6, 22, 10], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 225, 100)}),
                (1, {'path': [7, 23, 11], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 225, 100)}),
                (1, {'path': [7, 27, 9], 'v_max': self.v, 'T' : 0.1,'s0' : 4, 'colour': (225, 225, 100)}),
                (1, {'path': [6, 31, 12], 'v_max': self.v ,'T' : 0.1,'s0' : 4, 'colour': (225, 225, 100)}),
