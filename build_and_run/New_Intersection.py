    ...
    #all interfearing paths
        ...
        self.vg = VehicleGenerator({
            ...
            'vehicles': [
                ...
                (1, {'path': [0, 16, 12], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (0, 0, 255)}),
                (1, {'path': [1, 17, 13], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (0, 0, 255)}),
                (1, {'path': [32, 24, 33], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (255, 0, 0)}),
                (1, {'path': [0, 28, 14], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (0, 0, 255)}),
                ...
                (1, {'path': [3, 19, 15], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (0, 0, 255)}),
                (1, {'path': [34, 25, 35], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (255, 0, 0)}),
                (1, {'path': [2, 29, 8], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (0, 0, 255)}),

                #North [Inner Straight, Outer Straight, Right Turn, Left Turn]
                (1, {'path': [4, 20, 8], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 0, 225)}),
                (1, {'path': [5, 21, 9], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 0, 225)}),
                (1, {'path': [36, 26, 37], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 0, 225)}),
                ...
                (1, {'path': [6, 22, 10], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 225, 0)}),
                (1, {'path': [7, 23, 11], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (255, 0, 0)}),
                (1, {'path': [38, 27, 39], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 225, 0)}),
                (1, {'path': [6, 31, 12], 'v_max': self.v+ 2*self.speed_variance*np.random.random() -self.speed_variance, 'colour': (225, 225, 0)}),
