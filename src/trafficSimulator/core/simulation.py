    ...
    def update(self):
        ...
        for segment in self.segments:
            ...
            if len(segment.vehicles) != 0:
                ...
                if self.emCount > 0:
                    self.vehicles[segment.vehicles[0]].setMax(self.vehicles[segment.vehicles[0]].OG_v_max)
                else:
                    self.vehicles[segment.vehicles[0]].setMax(self.vehicles[segment.vehicles[0]].OG_v_max * 1.5)
            ...
            for i in range(1, len(segment.vehicles)):
                ...
                if self.emCount > 0:
                    self.vehicles[segment.vehicles[i]].setMax(self.vehicles[segment.vehicles[i]].OG_v_max)
                else:
                    self.vehicles[segment.vehicles[i]].setMax(self.vehicles[segment.vehicles[i]].OG_v_max * 1.5)
        ...
        for segment in self.segments:
            ...
            if vehicle.x >= segment.get_length():
                ...
                self.vehicles[segment.vehicles.popleft()] 
